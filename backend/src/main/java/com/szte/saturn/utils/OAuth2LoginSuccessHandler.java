...
public class OAuth2LoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        Optional<ConnectedAccount> connectedAccount = connectedAccountRepository.findByProviderAndProviderId(provider, providerId);
        ...
        if(existingUser != null) {
            ConnectedAccount newConnectedAccount = new ConnectedAccount(provider, providerId, existingUser);
    ...
    private void authenticateUser(User user, HttpServletResponse response) throws IOException {
        ...
        cookie.setPath("/");
        cookie.setMaxAge(60 * 60 * 24); // 1 nap
